...
export const metadata: Metadata = {
  title: "Popd — Local marketing on autopilot",
  description:
    "Popd runs social media and local SEO for local businesses automatically — writing posts, turning Google reviews into content, and keeping you visible. Pick your niche, set it once, and it just runs.",
  openGraph: {
    title: "Popd — Local marketing on autopilot",
    description:
